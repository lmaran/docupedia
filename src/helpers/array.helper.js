...
export const groupBySubKey = (array, key, subKey) => {
    return array.reduce((acc, crt) => {
 ...
 */
export const move = (array, fromIdx, toIdx) => {
 ...
 */
export const moveOrInsertObjectAtIndex = (array, newElement, keyName, newIdx) => {
 ...
 * This  method mutes the original array, so be sure the input array is not null
 */
export const moveOrInsertStringAtIndex = (array, newElement, newIdx) => {
...
//     selectedPosition: 0
// }
export const getAvailablePositions = (items, itemId, onlyValues) => {

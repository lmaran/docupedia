export const endsWithValueFromList = (str, endValues) => {
 ...
 */
export const getIntervalFromAcademicYear = (academicYear, noSpace) => {
 ...
 * output: 201920
 */
export const getAcademicYearFromInterval = (interval) => {

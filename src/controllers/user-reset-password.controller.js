...
export const displayResetPasswordAskToConfirm = async (req, res) => {
    res.render("user/reset-password-ask-to-confirm");
};

export const getResetPasswordConfirm = async (req, res) => {
    try {
...
export const getResetPasswordConfirmSuccess = async (req, res) => {
    const data = {

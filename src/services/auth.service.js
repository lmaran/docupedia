...
export const signupByInvitationCode = async (firstName, lastName, password, invitationCode) => {
...
export const signupByUserRegistration = async (firstName, lastName, email, psw) => {
    const existingUser = await userService.getOneByEmail(email);
...
export const saveResetPasswordRequest = async (email, password) => {
    const existingUser = await userService.getOneByEmail(email);
...
export const signupByActivationCode = async (activationCode) => {
...
export const resetPasswordByCode = async (resetPasswordCode) => {

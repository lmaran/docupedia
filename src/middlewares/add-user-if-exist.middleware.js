...
import * as roleAssignmentsService from "../services/role-assignments.service.js";
import * as roleDefinitionsService from "../services/role-definitions.service.js";
import * as cookieHelper from "../helpers/cookie.helper.js";

export const addUserIfExist = async (req, res, next) => {
